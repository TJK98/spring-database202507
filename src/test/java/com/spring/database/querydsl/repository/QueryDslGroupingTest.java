...
public class QueryDslGroupingTest {
    ...
    void tupleTest() {
        ...
        //when
        // 컬럼이 2개 이상일 때 List<Tuple>, select()에 선언한 순서대로 값 저장
        // Tuple: QueryDSL에서 여러 컬럼 조회할 때 사용하는 결과 컨테이너
    ...
    @Test
    @DisplayName("전체 그룹화 하기 - GROUP BY 없이 집계 함수를 사용하는 것")
    void groupByTest() {
        //given
